...
class BkashController extends Controller
{
    ...
    public function createPayment(Request $request)
    {
        ...
        // if (((string) $requestData->amount != (string) session()->get('bkash')['invoice_amount'])) {
        ...
        $requestData['merchantCallbackURL'] = url('/bkash/callback');
    ...
    //         'merchantCallbackURL' => url('/bkash/callback')
    //     ];
