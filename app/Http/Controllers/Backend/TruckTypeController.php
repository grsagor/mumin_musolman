...
class TruckTypeController extends Controller
{
    ...
    {
        return view('backend.pages.truck_type.index');
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('backend.pages.truck_type.edit', compact('truck_details'));
    }
    ...
    public function rentAmountHtml(Request $request)
    {
        $value = $request->value;
        $containerClass = $request->containerClass;
        return view('backend.pages.truck_type.rent_amouont_html', compact('value', 'containerClass'));
    }
    public function rentAmountIncrement(Request $request)
    {
        $num = $request->num;
        $containerClass = $request->containerClass;
        return view('backend.pages.truck_type.rent_amouont_add', compact('num', 'containerClass'));
    }
    ...
    public function distance()
    {
        ...
        $distance = Helper::distance($pickupLat, $pickupLng, $destinationLat, $destinationLng);
...
/* composer require guzzlehttp/guzzle */ #for distance
