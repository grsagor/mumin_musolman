...
class PremiumamolvideoController extends Controller
{
    public function index()
    {
        return view('backend.pages.premium_amol_video.index');
    }

    public function getList(Request $request)
    {

        $data = PremiumAmolVideo::all();
    ...
    {
        $id = $request->id;
        $video = PremiumAmolVideo::find($id);
        return view('backend.pages.premium_amol_video.edit', compact('video'));
    }
