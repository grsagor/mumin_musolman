...
class TotalmessageController extends Controller
{
    public function index()
    {
        return view('backend.pages.total_message.index');
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('backend.pages.total_message.edit', compact('truck_details'));
    }
