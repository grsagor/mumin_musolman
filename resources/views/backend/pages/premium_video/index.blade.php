...
@section('content')
    <div class="container-fluid px-4">
        <h4 class="mt-2">প্রিমিয়াম ভিডিও</h4>
    ...
    @include('backend.pages.premium_video.modal')
    @push('footer')
        <script type="text/javascript">
            function getusers(name = null, email = null, phone = null) {
                var table = jQuery('#dataTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('admin.video.premium.get.list') }}",
                        type: 'GET',
                        data: {
                            'name': name,
                            'email': email,
            ...
            $(document).on('click', '.edit_btn', function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.video.premium.edit') }}",
                    type: "GET",
                    data: {
                        id: id
                    },
            ...
            $(document).on('click', '.delete_btn', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('admin.video.premium.delete') }}",
                            type: "GET",
                            data: {
                                id: id
                            },
