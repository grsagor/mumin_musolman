...
class AmolvideoController extends Controller
{
    public function index()
    {
        return view('backend.pages.amol_video.index');
    }
    ...
    {
        $id = $request->id;
        $video = AmolVideo::find($id);
        return view('backend.pages.amol_video.edit', compact('video'));
    }
